...
def main():
    ...
    parser.add_argument(
        "--save_dir",
        default="/hkfs/work/workspace/scratch/bh6321-E1/weights",
        help="saves the model, if path is provided",
    )
    ...
    tft = DeepAR.from_dataset(
        training, learning_rate=0.03, hidden_size=32, dropout=0.1, log_interval=100, reduce_on_plateau_patience=4
    )
